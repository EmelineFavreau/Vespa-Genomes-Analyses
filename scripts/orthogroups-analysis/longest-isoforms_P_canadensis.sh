...
# Obtain longest transcript for  each gene in Polistes canadensis
...
mv GCF_001313835.1_ASM131383v1_protein.faa.gz P_canadensis.gff.gz

thisspecies="P_canadensis"
...
# this protein fasta has 9876 longest isoforms, with headers containing just gene id (i.e. >XP_014597714.1)
