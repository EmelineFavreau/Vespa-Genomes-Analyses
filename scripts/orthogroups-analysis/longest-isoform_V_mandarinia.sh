...
wget https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/014/083/535/GCF_014083535.2_V.mandarinia_Nanaimo_p1.0/GCF_014083535.2_V.mandarinia_Nanaimo_p1.0_genomic.gff.gz

mv GCF_014083535.2_V.mandarinia_Nanaimo_p1.0_genomic.gff.gz V_mandarinia.gff.gz

thisspecies="V_mandarinia"
...
grep -v -f gff/${thisspecies}-mitochondrial-gene sequence-length/${thisspecies}-sequence-length.tsv > sequence-length/${thisspecies}-sequence-length-no-mito.tsv
...
# this protein fasta has 10107 longest isoforms, with headers containing just gene id (i.e. >NP_001291509.1)
